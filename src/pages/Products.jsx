...
function Products() {
    ...
    useEffect(() => {
        ...
        if (searchString) {
            ...
            searchTimer = setTimeout(() => {
                const temp = products.filter(product => product.name.toLowerCase().includes(searchString.toLowerCase()));
    ...
    return (
        <div>
            ...
            <div className="flex items-center max-w-5xl mx-auto my-4">
                <input
                    type="text"
                ...
                <div className="max-w-5xl mx-auto bg-white rounded-lg shadow-lg p-6 flex items-start mb-2">
                    ...
                    <div className="w-2/4 pl-6">
                        <div className="flex justify-between items-start">
                            ...
                            <div>
                                <Link to={`/product-details/${product.id}/description?name=${product.name}&price=${product.price}`}>

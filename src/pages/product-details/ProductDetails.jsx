...
function ProductDetails() {
    ...
    // const productId = 12;
    const filteredProduct = products.find(filteredProduct => filteredProduct.id === parseInt(productId));
    return (
        <div>
            <div className="max-w-5xl mx-auto bg-white rounded-lg shadow-lg p-6 flex items-start mb-2">
                ...
                <div className="w-3/4 pl-6">
                    ...
                    <div>
                        <p className="mb-2">{filteredProduct.price}</p>
                    ...
                    <nav className="bg-gray-800 p-4">
                        <div className="container mx-auto flex justify-between">
                            <div className="flex space-x-4">
                                <Link to="description" className="text-white hover:bg-gray-700 px-3 py-2 rounded text-sm">Product Description</Link>
                                <Link to="specifications" className="text-white hover:bg-gray-700 px-3 py-2 rounded text-sm">Specifications</Link>
                                <Link to="frequently-brought-together" className="text-white hover:bg-gray-700 px-3 py-2 rounded text-sm">Frequently Bought Together</Link>
                                <Link to="rating-reviews" className="text-white hover:bg-gray-700 px-3 py-2 rounded text-sm">Ratings & Reviews</Link>
                            </div>
                        </div>
                    </nav>
                    <Outlet/>
